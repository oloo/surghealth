...
setup(name='trytond_mxl_health',
    ...
    package_dir={'trytond.modules.mxl_health': '.'},
    packages=[
        'trytond.modules.mxl_health'

        ],
    package_data={
        'trytond.modules.mxl_health': info.get('xml', []) \
    ...
    entry_points="""
    [trytond.modules]
    mxl_health = trytond.modules.mxl_health
    """,
    test_suite='tests',
